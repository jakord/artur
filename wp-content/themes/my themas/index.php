...
<div class="row">
            <div class="col-sm-12 row1">
                <div class="row">
                   <div class=" col-sm-4">  
                    <div class=" pull-left"><img src="<?php bloginfo('template_url')?>/image/flag.png" alt="flag"></div>
                        <div class="row1-article-right">
                        ...
                        <a href="#" >read more</a><img src="<?php bloginfo('template_url')?>/image/arrow.png" alt="arrow">
                        </div>
                   </div>

                   <div class=" col-sm-4">  
                    <div class=" pull-left"><img src="<?php bloginfo('template_url')?>/image/fo.png" alt="foto"></div>
                        <div class="row1-article-right">
                        <h5 >Ausce Cellentes</h5>
                        <p >Phasellus ultrices nulla quis nibh. Quisque a lectus. Donec consectetuer ligula vulputate sem tristique</p>
                        <a href="#" >read more</a><img src="<?php bloginfo('template_url')?>/image/arrow.png" alt="arrow">
                   ...
                   <div class=" col-sm-4">  
                    <div class=" pull-left"><img src="<?php bloginfo('template_url')?>/image/hs.png" alt="house"></div>
                        <div class="row1-article-right">
                        <h5 >Ausce Cellentes</h5>
                        <p >Phasellus ultrices nulla quis nibh. Quisque a lectus. Donec consectetuer ligula vulputate sem tristique</p>
                        <a href="#" >read more</a><img src="<?php bloginfo('template_url')?>/image/arrow.png" alt="arrow">
      ...
      <div class="row">
          <div class="col-sm-8">
           <div class="row article">
             <div class="col-sm-4 col-xs-4"><img src="image/img1.png" alt="image" class="<?php bloginfo('template_url')?>/img-rounded img-responsive" > </div>
             <div class="col-sm-8  col-xs-8 row"><h5 class="header">Lorem ipsum dolor sit amet</h5> 
             <p>sed egestas, ante et vulputate volutpat, eros pede semper est, vitae luctus metus libero eu augue. Morbi purus libero, faucibus adipiscing, commodo quis, gravida id, est. Sed lectus tpat, lacus a ultrices sagittis, mi neque euismod dui, eu pulvinar nunc sapien ornare nisl. Phasellus pede arcu, dapibus eu</p> 
              <a href="#"  class="btn btn-danger btn-lg">More Info</a> 
             </div>
             </div>

             <div class="row article">
             <div class="col-sm-4  col-xs-4"><img src="image/img2.png" alt="image" class="<?php bloginfo('template_url')?>/img-rounded img-responsive" > </div>
      ...
      <div class="row">
       ...
       <div class="row row4">
           ...
           <div class=" col-md-12 ">
                ...
                <div class="col-md-6">
                 <div class="row">
                    <div class="col-sm-12  row4-left-article-bottom">
                    <div class="row">
                      <div class="col-sm-2 col-xs-2 "><img src="<?php bloginfo('template_url')?>image/kl1.png" alt="kalendar"></div>
                ...
                <div class=" col-md-6 ">
                   ...
                   <div class="row">
                     <div class="col-sm-12   article-bottom">
                      <div class="row">
                        <div class="col-sm-9 col-xs-10 row4-right-article">Sed egestas, ante et vulputate volutpat, eros pede semper est, vitae luctus metus libero eu augue.Morbi purus libero, faucibus adipiscing, commodo quis, gravida id, est. Sed lectus. Praesent elementum hendrerit tortor. Sed semper lorem at felis. Vestibulum volutpat, lacus a ul.
                        <br/><span>- John Doe</span>
                      </div>
                       <div class="col-sm-3 col-xs-2 "><img src="<?php bloginfo('template_url')?>image/qs.png" class="img-responsive"  alt=""></div>
                     </div> 
                      </div>    
                   </div>   
