<?php get_header(); ?>
        ...
        <div class="col-sm-8">
         <div class="row article">
           <div class="col-sm-4 col-xs-4"><img src="<?php bloginfo('template_url') ?>/image/img1.png" alt="image" class="img-rounded img-responsive" > </div>
      ...
      <div class="row">
       ...
       <div class=" col-md-12 row4">
             ...
             <div class=" col-md-6 ">
                 <div class="col-sm-12 row  article-bottom">
                  <div class="col-sm-9 col-xs-10 row4-right-article">Sed egestas, ante et vulputate volutpat, eros pede semper est, vitae luctus metus libero eu augue.Morbi purus libero, faucibus adipiscing, commodo quis, gravida id, est. Sed lectus. Praesent elementum hendrerit tortor. Sed semper lorem at felis. Vestibulum volutpat, lacus a ul.
                   ...
                   <div class="col-sm-3 col-xs-2  row"><img src="<?php bloginfo('template_url') ?>/image/qs.png" class="img-responsive"    alt=""></div>
                 </div>   
