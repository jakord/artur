...
function load_style_script(){
	...
	wp_enqueue_style('style', get_template_directory_uri() . '/style.css');
        wp_enqueue_script('jquery-library', get_template_directory_uri() . '/js/jquery1-11min.js');
	wp_enqueue_script('style-jquery', get_template_directory_uri() . '/js/bootstrap.js');
}
